...
class TestOrder(unittest.TestCase):
    ...
    def test_order_cars_by_price_desc_per_make_model(self):
        ...
        df_ordered_list = order.order_cars_by_price_desc_per_make_model(df)
        self.assertEqual(df_ordered_list[0].collect()[0]["price"], 100.0, "Cars not ordered correctly by price")
        self.assertEqual(df_ordered_list[0].collect()[1]["price"], 3.0, "Cars not ordered correctly by price")
        self.assertEqual(df_ordered_list[0].collect()[2]["price"], 2.0, "ACars not ordered correctly by price")
